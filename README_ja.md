...
そしてさらに以下は、Blockに対してもモディファイアを用いた例です。
...
ただし、単にblock自体がactiveかもしくはinactiveかという事実に追従する形で、Elementにもモディファイアを付加していたという理由なのであれば、
...
これの対策の一つとして、Block及びモディファイア表現を短縮する方法などもよく見かけます。
